...
public class CodeGenerator {
    ...
    public void run() {
        ...
        gc.setOutputDir("D:\\newlife4\\tmall" + "\\src\\main\\java");

        gc.setAuthor("liqiqiorz");
        gc.setOpen(false); //生成后是否打开资源管理器，就是生成的代码是否自动打开
        gc.setFileOverride(false); //重新生成时文件是否覆盖，第一次代码生成，你再生成第一次会被覆盖
        ...
        //要加个时区的。。数据库配置嘛
        dsc.setUrl("jdbc:mysql://localhost:3306/tmall_springboot?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT");
        ...
        //三个包名(有人习惯两个，就是G
        pc.setParent("com.yxr");
        //A
        pc.setModuleName("tmall"); //模块名
        //生成包的名字
        ...
        strategy.setInclude("category","order_","orderitem","product","productimage","property","propertyvalue","review","user");
